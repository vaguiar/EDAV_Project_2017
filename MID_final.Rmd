...
### Plotting Originators of most conflicts 
...
#ggplot(data=WarTopOrig, aes(x = vars, y = n, label= ifelse(n>8, as.character(StAbb), ''))) + 
#  geom_point(size = 1, color = 'red') +
 # geom_label_repel(
 #   aes(vars, n, fill = factor(StAbb)),
...
ggplot() + 
  ...
  geom_label_repel(data=WarTopOrig,
    aes(x = vars, y = n, label= ifelse(n>=numOfConflicts, as.character(StAbb), ''), 
        fill = factor(StAbb)),
    fontface = 'bold', color = 'white',
    box.padding = unit(0.35, "lines"),
    point.padding = unit(0.5, "lines"),
