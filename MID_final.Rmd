...
attacked <- ggplot() + 
  ...
  theme_classic(base_size = 16) +
  ggtitle("Top Countries Attacked During Conflicts") +
  xlab("Year") +
  ylab("Count") + theme(legend.position = "none")
...
The purpose of the graph above was to plot the most belligerent/victimized countries during conflicts happening each year.

The graph sheds light on the number of conflicts happening before, during and towards the end of a war. In some cases, we see that the number of conflicts initiated by a particular country serve as valid predictor of their attitude towards a full scale conflict. 
