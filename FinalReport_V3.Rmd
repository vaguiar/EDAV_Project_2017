...
```
As seen above, most categorical variables have been neatly factored to maintain conformance in formats such as 0 being the lowest and increasing there one. This aides in better data representation. 
...
```
In the graph plotting War Time Correlations, we see that most of the data points for Fatality, Settlement and Outcome gravitate towards the top half. There's also a high level of correlation in there. As for the Peace Time Correlations, the first three variables seem pretty evenly distributed.
...
```
In the graph above we have plotted the Fatalities occurring due to militarized conflicts every year since the year 1900. We've faceted the graphs by the number of casualties starting from 1-25, 25-100 and so on. 
