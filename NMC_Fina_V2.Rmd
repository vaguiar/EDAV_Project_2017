...
The graph on the right shows thAnother observation that is unique to the cold war is that following the war, the CINC values are missing for Japan and Germany. Also the values are missing for a year for France right before the end of the war.
