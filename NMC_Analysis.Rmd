...
a<- ggplot() + 
  ...
  geom_line(data = NMC2_yr, aes(x = year, y = irst, color = stateabb, group = stateabb))

b<-ggplot() + 
  geom_rect(data=d, mapping=aes(xmin=x1, xmax=x2, ymin=0, ymax=1, fill=Conflict),alpha=0.15) +
  geom_line(data = NMC2_yr, aes(x = year, y = milex, color = stateabb, group = stateabb))


c<-ggplot() + 
  geom_rect(data=d, mapping=aes(xmin=x1, xmax=x2, ymin=0, ymax=1, fill=Conflict),alpha=0.15) +
  geom_line(data = NMC2_yr, aes(x = year, y = milper, color = stateabb, group = stateabb))


d<-ggplot() + 
  geom_rect(data=d, mapping=aes(xmin=x1, xmax=x2, ymin=0, ymax=1, fill=Conflict),alpha=0.15) +
  geom_line(data = NMC2_yr, aes(x = year, y = tpop, color = stateabb, group = stateabb))
