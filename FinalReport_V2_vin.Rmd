...
y2_high =30
d = data.frame(x1=c(1914, 1939, 1947, 1950, 1955, 2001), 
               x2=c(1918, 1945, 1991, 1953, 1975, 2010), 
               y1=c(0,0,0,0,0,0),
               y2=c(y2_high,y2_high,y2_high,y2_high,y2_high,y2_high),
               Conflict=c("WWI", "WWII", "Cold War", "Korean War", "Vietnam War", "Afghanistan War"), 
               r=c(1,2,3,4,5,6))
...
ggplot() + 
  ...
  scale_fill_manual( 
    ...
    values=c("green", "red", "skyblue", "salmon", "paleturquoise3", "lightsteelblue2", "lightsteelblue4", "lightsteelblue3", "pink3", "green", "pink", "red", "orange", "yellow", "blue", "salmon", "paleturquoise3", "lightsteelblue2", "lightsteelblue4", "lightsteelblue3", "pink3"))
